...
(gc "CSharp\Reports\Cobertura_altcover.xml") | % { $_ -replace $pathToReplace2, $replacement } | Out-File "CSharp\Reports\Cobertura_altcover.xml" -Encoding UTF8Revert database - fixing a bug