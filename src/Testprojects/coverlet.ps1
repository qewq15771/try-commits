...
(gc "CSharp\Reports\Cobertura_coverlet.xml") | % { $_ -replace $pathToReplace, $replacement } | Out-File "CSharp\Reports\Cobertura_coverlet.xml" -Encoding UTF8Refactor README - handling edge casesRevert UI - removing deprecated function