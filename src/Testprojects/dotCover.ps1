...
(gc "FSharp\Reports\dotCover.xml") | % { $_ -replace $pathToReplace2, $replacement } | Out-File "FSharp\Reports\dotCover.xml" -Encoding UTF8Improve styles - fixing a bugRevert README - improving security